            ...
            $(this).magnificPopup({ 
                ...
                image: {
                    ...
                    markup: '<div class="project-preview mfp-with-anim">' +
                                ...
                                '<div class="mfp-img mfp-projectLink"></div>' +
                                ...
                                '<div class="mfp-projectDetail">' +
                                    '<div class="mfp-projectTrigger">' +
                                        ...
                                        '<div class="mfp-projectTitleWrap">' +
                                            '<div class="display-table-cell vertical-align-middle">' +
                                                '<span class="display-block font-family-alt letter-spacing-1 text-small text-uppercase">Project1</span>' +
                                    ...
                                    '<div class="mfp-triggerClose text-center mfp-projectLink linkpage">' + 
                                    '<a class="mfp-projectLink linkpage">' +
                                    '<div class="trial">' + 
                                    '<span class="font-family-alt letter-spacing-2 text-uppercase text-extra-large text-white">Go to Project</span>' +
                                    '</div>' +
                                    '</div>' +
                                '</div>' +
                            '</div>'
